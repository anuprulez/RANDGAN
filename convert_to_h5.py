...
train_pred_path = base_path + "train_pred/"
test_path = base_path + "test/"
test_pred_path = base_path + "test_pred/"
tr_h5 = "train_images_negative_txt_file.h5"
tr_pred_h5 = "train_images_negative_txt_file_pred.h5"
...
print("Saving training pred/segmented images...")
convert_hdf5_train(read_text_file("train_split.txt"), train_pred_path, tr_pred_h5, "tr_pred_images")

print("Saving test images...")
convert_hdf5_test(read_text_file("test_split.txt"), test_path, te_h5, "te_images")

print("Saving test pred/segmented images...")
